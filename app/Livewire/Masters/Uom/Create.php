...
class Create extends Component
{
    ...
    public function store(): void
    {
        ...
        try {
            ...
            Flux::toast('UOM with this name or code already exists', variant: 'danger', position: 'top right');
            throw $e;
        } catch (Exception $e) {
            Flux::toast('An error occurred while creating unit of measure', variant: 'danger', position: 'top right');
            throw $e;
        }
    }
