...
class Index extends Component
{
    ...
    public function destroy(): void
    {
        ...
        try {
            ...
            Flux::toast('Cannot delete tax. It may be in use.', variant: 'danger', position: 'top right');
            $this->deleteId = null;
            $this->modal('delete-tax-confirmation')->close();
        } catch (\Exception $e) {
            Flux::toast('An error occurred while deleting the tax.', variant: 'danger', position: 'top right');
            $this->deleteId = null;
            $this->modal('delete-tax-confirmation')->close();
        }
    }
