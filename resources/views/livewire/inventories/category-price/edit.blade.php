<flux:modal name="edit-category-price" class="w-full max-w-2xl">
    <form wire:submit="update">
        <div class="space-y-6">
            <flux:heading size="lg">Edit Category Price</flux:heading>
            ...
            <div class="flex">
                ...
                <flux:button
                    type="button"
                    variant="ghost"
                    x-on:click="$flux.modal('edit-category-price').close()"
                >
                    Cancel
                </flux:button>
