<flux:modal name="create-uom-conversion" class="w-full max-w-2xl">
    <form wire:submit="save">
        <div class="space-y-6">
            <flux:heading size="lg">Create UOM Conversion</flux:heading>
            ...
            <div class="flex">
                <flux:spacer />
                <flux:button type="button" variant="ghost" x-on:click="$flux.modal('create-uom-conversion').close()">
                    Cancel
                </flux:button>
