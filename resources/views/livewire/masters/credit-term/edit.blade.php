<flux:modal name="edit-credit-term" class="w-full max-w-2xl">
    <form wire:submit="save">
        <div class="space-y-6">
            <flux:heading size="lg">Edit Credit Term</flux:heading>
            ...
            <div class="flex">
                <flux:spacer />
                <flux:button type="button" variant="ghost" x-on:click="$flux.modal('edit-credit-term').close()">
                    Cancel
                </flux:button>
