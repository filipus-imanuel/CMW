<flux:modal name="create-user-group" class="w-full max-w-2xl">
    <form wire:submit="save">
        <div class="space-y-6">
            <flux:heading size="lg">Create User Group</flux:heading>
            ...
            <flux:button
                type="button"
                variant="ghost"
                x-on:click="$flux.modal('create-user-group').close()"
            >
                Cancel
            </flux:button>
