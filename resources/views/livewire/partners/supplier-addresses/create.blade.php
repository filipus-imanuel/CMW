<flux:modal name="create-supplier-address" class="w-full max-w-3xl">
    <form wire:submit="save">
        <div class="space-y-6">
            <flux:heading size="lg">Create Supplier Address</flux:heading>
            ...
            <div class="flex">
                <flux:spacer />
                <flux:button type="button" variant="ghost" x-on:click="$flux.modal('create-supplier-address').close()">
                    Cancel
                </flux:button>
